    ...
    while true; do
        ...
        case $set_opt in
            ...
            9|09)
                ...
                echo -e ""
                # Test each path with a 5-second timeout to avoid freezing
                ...
                echo -e " If you see '400' or '000', check that you have created at least one account for each protocol."
                echo -e ""
