...
# ==========================================
# 7. NGINX & HAPROXY MULTIPLEXER (with improved SSL)
# ==========================================
...
server {
    ...
    # Modern SSL configuration for compatibility
    ...
    while true; do
        ...
        case $set_opt in
            ...
            11)
                ...
                echo -e " (This may take a few seconds; look for 'CONNECTED' and 'Verify return code')"
                echo -e ""
